...
**Office Hours:** MW 3:10--4:30 p.m., T 2:00--4:00 p.m., F 11:00 a.m.--12:30 p.m.
...
The use of the R statistical environment with the RStudio interface (downloadable from rstudio.org) is thoroughly integrated into the course. You have two options for using RStudio:
...
2. A **local** version of RStudio installed on your machine. This is recommended due to the computational resources this course demands. The downside to this approach is that your work is only stored locally, but I get around this problem by keeping all of my work in a Dropbox folder. 
...
Unless otherwise noted, you should assume that it will be helpful to bring a laptop to class if you choose to use the **local** version of RStudio. 
...
There will be several problem sets over the course of the term. Problem sets will involve computational assignments in R with written explanations. In order to streamline your workflow and my ability to comprehend your work, you should complete all of your homework assignments in R Markdown. All homework will be submitted electronically on github.
...
*You will only get as much out of this class as you put in.* I am including your level of engagement as part of your final grade to remind you of this fact. Your attendance in class is crucial, as is your punctuality; however, attending class is not sufficient to be a fully engaged student. Being prepared, dilligently working on class examples, asking questions, and attending office hours are all examples of how you can show me that you are engaged in the course.
...
All students are expected to uphold Lawrence University’s Honor Code. You will often be encouraged to work collaborativly, but copying and pasting sentences, paragraphs, or blocks of R code is not acceptable. All of your written work must be accompanied by a reaffirmation of the Honor Code.
